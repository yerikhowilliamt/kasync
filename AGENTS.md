...
- **Task Initialization & Git Branching:** Before starting any task, switch to `dev` and pull latest (`git checkout dev && git pull origin dev`), then create and switch to a new task branch (e.g. `feat/xxx`, `fix/xxx`, `docs/xxx`).
